 ...
 * 
 * Note that this part of the hand-out has been adapted from a mere interface
 * to an actual code skeleton, artifacts of this somewhat organic transformation
 * might remain.
...
import control.EstimatorInterface2;

public class DummyLocalizer2 implements EstimatorInterface2 {
	...
	public DummyLocalizer2( StateModel stateModel) {
		...
		// initialize true state directly,
		// since there is no robot simulator (yet)
	...
	// -- - --------------------------------------------------------
	//public double getTProb( int x, int y, int h, int nX, int nY, int nH) {return 0.0;}

	//public double getOrXY( int rX, int rY, int x, int y, int h) {return 0.1;}

	//public double getCurrentProb( int x, int y) {double ret = 0.0;return ret;}
