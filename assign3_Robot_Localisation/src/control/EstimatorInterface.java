...
public interface EstimatorInterface {
	...
	/**
	 * should trigger one step of the estimation, i.e., true position, 
	 * sensor reading and the probability distribution for the position 
	 * estimate should be updated one step after the method has been called once.
	 */
	public void update();
	...
	/**
	 * Returns the currently available sensor reading.
	...
	/**
	 * Returns the currently estimated (summed) probability for the robot.
	 * @Return the currently estimated (summed) probability to be in position
	 ...
	 * @return the probability entry to get reading r corresponding 
	...
	/**
	 * Returns the probability entry (Tij) of the transition matrix T.
	 * @return the probability entry (Tij) to go from pose 
